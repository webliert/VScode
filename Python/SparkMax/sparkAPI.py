...
# 收到websocket关闭的处理
def on_close(ws,arg1,arg2):     #此处对例程进行了修改，源例程会报错显示参数数量不匹配
    print("### closed ###")
...
if __name__ == "__main__":
    main(
        appid="1bbd2cc9",
        api_secret="ZDllM2ExNDYyZTc1YmZhZjZiN2ZiMzQ4",
        api_key="75d206c1e9b9a8d4ee1727498b9938d9",
